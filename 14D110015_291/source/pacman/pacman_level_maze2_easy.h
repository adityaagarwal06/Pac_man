...
void pacMove(char c,int &dx,int &dy) //movement of pacman
    {
        switch(c){//w,a,s,d to move the pacman.
...
while(true)
{
          ...
          /* Hidden to activate thru channel
            ...
            else if(c1.getY()>=206.5 && c1.getY()<=208.5 && c1.getX()<=746 && c1.getX()>=744 && dx>0){continue;}

            else if(c1.getY()>=291.5 && c1.getY()<=293.5 && c1.getX()<=746 && c1.getX()>=744 && dx>0){continue;}
        ...
        /*  Hidden to activate thru channel
            ...
            else if((c1.getY()>=334 && c1.getY()<=336 && c1.getX()<=971 && c1.getX()>=969 && dx>0)||
                    (c1.getY()>=334 && c1.getY()<=336 && c1.getX()<=971 && c1.getX()>=969 && dy<0)){continue;}

            else if(c1.getY()>=384 && c1.getY()<=386 && c1.getX()<=971 && c1.getX()>=969 && dx>0){continue;}
